...
<?php
    //查詢sql語法
    $sql = "SELECT `classTypeId`,`classTypeName`
            FROM `class_Type`
            WHERE `classTypeId` = ? ";
                    ...
                    <div class="col-md-3">
                        <form name="myForm" method="POST" action="./update_Category.php"  role="form">
                            <div class="form-group">
                                <label>類別名稱</label>
                                <input type="text" class="form-control" maxlength="10" name="classTypeName"  value="<?php echo $arr['classTypeName']; ?>" placeholder="最多30字元">
                            </div>
